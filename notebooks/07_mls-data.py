...
#
# there is a missing month in January 2025 that is also missing in each day of the daily data.
...
# %%
# data[252, ...] = np.nanmean(data_jan_2025, axis=0)
...
# %%
mass_h2o_2024 = np.ma.masked_all(12)
for month in range(12):
...
era5_h2o_mass_2024 = np.ma.masked_all(12)
for month in range(12):
...
# %%
X, Y = np.meshgrid(np.arange(2004+1/24, 2025, 1/12), era5_plev[1:])
...
# %%
# crude method since RT code not compiling
day_weight_noleap = np.array([31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31])
day_weight_leap = np.array([31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31])

# %%
np.average(era5_h2o_mass_2022 - era5_h2o_mass_20042021, weights=day_weight_noleap)

# %%
np.average(era5_h2o_mass_2023 - era5_h2o_mass_20042021, weights=day_weight_noleap)

# %%
np.average(era5_h2o_mass_2024 - era5_h2o_mass_20042021, weights=day_weight_noleap)

# %%
np.average(era5_h2o_mass_2025 - era5_h2o_mass_20042021, weights=day_weight_noleap)
