...
pl.plot(np.arange(1975+1/24,2024+1/24,1/12), aod_cmip7[-588:], label='CMIP7 v1.3.0 (1850-2023)', lw=0.5)
pl.plot(np.arange(2013+1/24,2025+1/24,1/12), aod_omps, label='OMPS LP (2013-2024)', lw=0.5)
